...
def kp_detection(db, k_ind, data_aug, debug):
    ...
    # make subject items here
    sub_tl_heatmaps = np.zeros((batch_size, categories, output_size[0], output_size[1]), dtype=np.float32)
    sub_br_heatmaps = np.zeros((batch_size, categories, output_size[0], output_size[1]), dtype=np.float32)
    sub_tl_regrs    = np.zeros((batch_size, max_tag_len, 2), dtype=np.float32)
    sub_br_regrs    = np.zeros((batch_size, max_tag_len, 2), dtype=np.float32)
    sub_tl_tags     = np.zeros((batch_size, max_tag_len), dtype=np.int64)
    sub_br_tags     = np.zeros((batch_size, max_tag_len), dtype=np.int64)
    sub_tag_masks   = np.zeros((batch_size, max_tag_len), dtype=np.uint8)
    sub_tag_lens    = np.zeros((batch_size, ), dtype=np.int32)


    # make object items here
    obj_tl_heatmaps = np.zeros((batch_size, categories, output_size[0], output_size[1]), dtype=np.float32)
    obj_br_heatmaps = np.zeros((batch_size, categories, output_size[0], output_size[1]), dtype=np.float32)
    obj_tl_regrs    = np.zeros((batch_size, max_tag_len, 2), dtype=np.float32)
    obj_br_regrs    = np.zeros((batch_size, max_tag_len, 2), dtype=np.float32)
    obj_tl_tags     = np.zeros((batch_size, max_tag_len), dtype=np.int64)
    obj_br_tags     = np.zeros((batch_size, max_tag_len), dtype=np.int64)
    obj_tag_masks   = np.zeros((batch_size, max_tag_len), dtype=np.uint8)
    obj_tag_lens    = np.zeros((batch_size, ), dtype=np.int32)
